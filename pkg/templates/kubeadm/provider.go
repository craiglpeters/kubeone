...
// Provider interface abstract differences between different kubeadm versions
...
func NewProvider(ver *semver.Version) Provider {
	switch {
	case v13x.Check(ver):
		return &kubeadmv1beta1{}
	case v14x.Check(ver):
		return &kubeadmv1beta1{}
	case v15x.Check(ver):
		return &kubeadmv1beta2{}
	}
